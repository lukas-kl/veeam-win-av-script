...
function Configure-BackupM365 {
	...
	Add-FirewallRule "Veeam Exclusion - Backup for M365 - CONSOLE" TCP "9192-9194" ([ref]$status)
...
function Configure-Orchestrator {
    ...
    Write-Host "`n=== Firewall Rules ===" -ForegroundColor White
	Add-FirewallRule "Veeam Exclusion - Orchestrator - Veeam Orchestrator Agents" TCP "8888" ([ref]$status)
    Add-FirewallRule "Veeam Exclusion - Orchestrator - Veeam ONE Reporter Web GUI" TCP "1239" ([ref]$status)
    Add-FirewallRule "Veeam Exclusion - Orchestrator - Veeam Orchestrator GUI" TCP "12348" ([ref]$status)
    Add-FirewallRule "Veeam Exclusion - Orchestrator - Veeam Orchestrator GUI" TCP "139,445" ([ref]$status)
    Add-FirewallRule "Veeam Exclusion - Orchestrator - License updates" TCP "443" ([ref]$status)
...
do {
    ...
    switch ($choice) {
        ...
        default { Write-Host "Invalid selection. Please enter 0-11." -ForegroundColor Red }
    }
